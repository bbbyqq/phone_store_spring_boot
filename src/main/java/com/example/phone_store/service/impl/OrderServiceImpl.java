...
import com.example.phone_store.enums.PayStatusEnum;
import com.example.phone_store.enums.ResultEnum;
import com.example.phone_store.exception.PhoneException;
import com.example.phone_store.repository.OrderMasterRepository;
import com.example.phone_store.repository.PhoneInfoRepository;
import com.example.phone_store.repository.PhoneSpecsRepository;
import com.example.phone_store.service.OrderService;
import com.example.phone_store.service.PhoneService;
import com.example.phone_store.util.KeyUtil;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderDTO create(OrderDTO orderDTO) {
        ...
        if (phoneSpecs == null) {
            ...
            throw new PhoneException(ResultEnum.SPESC_NOT_EXIST);
        }
